...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    private final Signal<Integer> signal1 = this.signal;
    ...
    public void no_subscription_no_gains() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnSubscribe(i -> hooksTriggered.add("subscribe"))//todo: change this line only
                ;
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnNext((v)-> {System.out.print(v); counter.incrementAndGet();})//todo: change this line only
                ;
    ...
    public void one_to_catch_them_all() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doFinally(signalType -> hooksTriggeredCounter.incrementAndGet())//todo: change this line only
                ;
    ...
    public void one_to_rule_them_all() {
        ...
        Flux<Integer> flux = Flux.just(1, 2, 3)
                .doOnEach(signal -> signals.add(signal.getType().name()))//todo: change this line only
                ;
